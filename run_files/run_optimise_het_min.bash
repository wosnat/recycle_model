...
~/work/RECYCLE_MODEL/recycle_model/run_least_squares_het.py --ref_csv  ~/work/RECYCLE_MODEL/recycle_model/reference_10cc.xlsx --ref_sample_id ${s} --vpro_json ${j} --json_dpath ~/work/RECYCLE_MODEL/results/${run_id}/json --out_dpath ~/work/RECYCLE_MODEL/results/${run_id}/out --run_id ${run_id} --model $m --f_scale $i --timeout 200  > ~/work/RECYCLE_MODEL/results/${run_id}/log/${run_id}.log 2>&1 &
