...
do
    ...
    baseid=rerun_het_DOC2750
    ODIR=${ODIR_base}/${baseid}/${fname}
    run_id=${baseid}
    sbatch --partition=hive7d,hiveunlim --wrap "$RDIR/model_equations_separate_NC_store_numba.py --ref_csv $RDIR/reference_final.xlsx  --outdpath ${ODIR}/out --model MIN --run_id $run_id --which_organism all --rerun_csv $fpath --override_init DOC,2750"
done
