...
do
	...
	ODIR=${ODIR_base}/${fname}
	run_id=${baseid}
	sbatch --partition=hive1d,hive7d,hiveunlim --wrap "$RDIR/model_equations_separate_NC_store_numba.py --ref_csv $RDIR/reference_final.xlsx  --outdpath ${ODIR}/out --model MIN --run_id $run_id --which_organism all --rerun_csv $fpath --override_init DIN,800"
	done
done
