...
do
    ...
    baseid=rerun_het_BP14
    ODIR=${ODIR_base}/${baseid}/${fname}
    run_id=${baseid}
    sbatch --partition=hive7d,hiveunlim --wrap "$RDIR/model_equations_separate_NC_store_numba.py --ref_csv $RDIR/reference_final.xlsx  --outdpath ${ODIR}/out --model MIN --run_id $run_id --which_organism all --rerun_csv $fpath --override_init Bp,1.4"
done
